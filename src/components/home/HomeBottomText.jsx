...
const HomeBottomText = () => {
    ...
    return (
        <div className='font-[font2] flex items-center justify-center gap-2 '>
            <p className='absolute lg:w-[17vw] w-64 lg:right-20 right-0 bottom-28 lg:bottom-28 lg:bottom-72 font-[font1] lg:text-lg text-xs lg:leading-relaxed leading-tight'>
