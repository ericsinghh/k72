    ...
    return (
        <div className='z-50 flex fixed top-0 w-full items-start justify-between pointer-events-none'>
            ...
            <div onClick={() => {
                ...
                className='lg:h-16 h-10 bg-black relative lg:w-[16vw] w-48 pointer-events-auto'>
                ...
                <div className='relative h-full lg:px-12 px-4 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
                    <div className={`lg:w-18 w-12 h-0.5 ${navColor === 'black' ? 'bg-black' : 'bg-white'}`}></div>
                    <div className={`lg:w-10 w-6 h-0.5 ${navColor === 'black' ? 'bg-black' : 'bg-white'}`}></div>
                </div>
            </div>
        </div>
    )
